...
public class Global implements GlobalObjects{
	...
	public WebElement findElementType(String locatorReference, locator locatorType){
		...
		element = null;
		WebDriverWait wait = new WebDriverWait(objInvokeBrowser.driver, 90);
		
		switch (locatorType) {
		
		case ID:
			wait.until(ExpectedConditions.presenceOfElementLocated(By.id(locatorReference)));
			element = objInvokeBrowser.driver.findElement(By.id(locatorReference));
			break;
			
		case XPATH:
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(locatorReference)));
			element = objInvokeBrowser.driver.findElement(By.xpath(locatorReference));
			break;
	...
	public List<WebElement> findElements(String locatorReference, locator locatorType){
		...
		case ID:
			lsElements = objInvokeBrowser.driver.findElements(By.id(locatorReference));
			break;
			
		case XPATH:
			lsElements = objInvokeBrowser.driver.findElements(By.xpath(locatorReference));
			break;
